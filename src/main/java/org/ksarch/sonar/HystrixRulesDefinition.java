...
public class HystrixRulesDefinition implements RulesDefinition {
    ...
    private void addMetadata(NewRule rule, String metadataKey) {
        URL resource = HystrixRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.json");
        if (resource != null) {
    ...
    private static void addHtmlDescription(NewRule rule, String metadataKey) {
        URL resource = HystrixRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.html");
        if (resource != null) {
